                        ...
                        <table className="table-fixed border-collapse border border-gray w-full h-full">
                            <thead>
                                <tr className="w-72 bg-yellow">
                                    <th className="border border-gray w-1/6">Nama Ruangan</th>
                                    <th className="border border-gray w-1/6">Lantai</th>
                                    <th className="border border-gray w-1/6">Kapasitas</th>
                                    <th className="border border-gray w-1/6">Waktu</th>
                                    <th className="border border-gray w-1/6">Status</th>
